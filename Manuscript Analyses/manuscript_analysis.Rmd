...
The relative variable importance for the models are shown in the figure below. The most important predictor for the AM1 initial intelligibility model was words-in-noise hearing threshold, followed by working memory, the interaction between working memory and inhibitory control, and the interaction between working memory and receptive vocabulary.
...
effect_plot(mods1, list_sort_c, flanker_c) # Working Memory * Inhibitory Control
effect_plot(mods1, flanker_c, list_sort_c) # Inhibitory Control * Working Memory
...
Plotting the interaction effects for the PDM10 initial intelligibility models. 
...
effect_plot(mods2, best_win, list_sort_c) # Words in Noise Threshold * Working Memory
effect_plot(mods2, best_win, int = F) # Words in Noise Threshold
effect_plot(mods2, list_sort_c, vocab_c) # Working Memory * Receptive Vocabulary
...
Two elastic net models were used to model the relationship between the listener cognitive measures and intelligibility improvement (controlling for pretest intelligibility) for AM1: the main effects only model and the model with interactions. 
...
effect_plot(mods12, flanker_c, vocab_c) # Inhibitory Control * Receptive Vocabulary
effect_plot(mods12, vocab_c, flanker_c) # Receptive Vocabulary * Inhibitory Control
...
effect_plot(mods22, flanker_c, best_win) # Inhibitory Control * Words in Noise Threshold
effect_plot(mods22, best_win, flanker_c) # Words in Noise Threshold * Inhibitory Control
